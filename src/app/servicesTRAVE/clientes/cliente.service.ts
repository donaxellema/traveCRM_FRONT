...
export class ClientesServiceCRM {
  ...
  constructor(
    ...
    getVerificacionDEClientes(data:any, prefix: string = ''): Observable<any> {
        ...
        return this.http.get(`${this.apiUrl}clientes_verifica/`, { headers: headers, params: paramsSeteados });
    }
    ...
    postClientes(data:any): Observable<any> {
        ...
        let httpParams = new HttpParams()
            //.set("id", id)
        return this.http.post(`${this.apiUrl}clientes/`, data,{ headers: headers, params: httpParams });
    }

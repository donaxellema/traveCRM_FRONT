  ...
  constructor(
    ...
    putPerfil(data:any): Observable<any> {
        ...
        let httpParams = new HttpParams()
            //.set("id", id)
        return this.http.put(`${this.apiUrl}perfil/`, data,{ headers: headers, params: httpParams });
    }
    ...
    getPerfilBY_ID(data:any, prefix: string = ''): Observable<any> {
        ...
        return this.http.get(`${this.apiUrl}perfil_by_id/`, { headers: headers, params: paramsSeteados });
    }
    ...
    postPassword(data:any): Observable<any> {
        ...
        let httpParams = new HttpParams()
            //.set("id", id)
        return this.http.post(`${this.apiUrl}perfil_pass/`, data,{ headers: headers, params: httpParams });
    }
    
    putImagen(data:any): Observable<any> {
        let headers = new HttpHeaders().set('Content-Type', 'application/json')
            .set('Authorization', (this.accessToken != null) ? this.accessToken : '');
        let httpParams = new HttpParams()
            //.set("id", id)
        return this.http.post(`${this.apiUrl}perfil_ima/`, data,{ headers: headers, params: httpParams });
    }

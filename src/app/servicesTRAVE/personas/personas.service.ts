...
export class personasServiceCRM {
  ...
  constructor(
    ...
    postPersonas(data:any): Observable<any> {
        ...
        let httpParams = new HttpParams()
            //.set("id", id)
        return this.http.post(`${this.apiUrl}personas/`, data,{ headers: headers, params: httpParams });
    }
    ...
    getPersonas(data:any, prefix: string = ''): Observable<any> {
        ...
        return this.http.get(`${this.apiUrl}personas/`, { headers: headers, params: paramsSeteados });
    }
    ...
    getPersonasSearch(data:any, prefix: string = ''): Observable<any> {
        ...
        let headers = new HttpHeaders()
            .set('Content-Type', 'application/json')
            .set('Authorization', this.accessToken ?  `${this.accessToken}`:'');
        return this.http.get(`${this.apiUrl}personasSearch/`, { headers: headers, params: paramsSeteados });
    }
    ...
    putPersonas(data:any): Observable<any> {
        ...
        let httpParams = new HttpParams()
            //.set("id", id)
        return this.http.put(`${this.apiUrl}personas/`, data,{ headers: headers, params: httpParams });
    }
    
    
    deletePersonas(data:any): Observable<any> {
        let headers = new HttpHeaders().set('Content-Type', 'application/json')
            .set('Authorization', (this.accessToken != null) ? this.accessToken : '');
        let httpParams = new HttpParams()
            //.set("id", id)
        return this.http.post(`${this.apiUrl}personasDelete/`, data,{ headers: headers, params: httpParams });
    }

...
export class campaniasServiceCRM {
  ...
  constructor(
    ...
    postCampanias(data:any): Observable<any> {
    ...
    getCampanias(data:any, prefix: string = ''): Observable<any> {
        ...
        return this.http.get(`${this.apiUrl}campanias/`, { headers: headers, params: paramsSeteados });
    }
    ...
    putCampanias(data:any): Observable<any> {
        ...
        let httpParams = new HttpParams()
            //.set("id", id)
        return this.http.put(`${this.apiUrl}campanias/`, data,{ headers: headers, params: httpParams });
    }
    ...
    getCampaniasSearch(data:any, prefix: string = ''): Observable<any> {
        ...
        let headers = new HttpHeaders()
            .set('Content-Type', 'application/json')
            .set('Authorization', this.accessToken ?  `${this.accessToken}`:'');
        return this.http.get(`${this.apiUrl}campanias_search/`, { headers: headers, params: paramsSeteados });
    }


    deleteCampanias(data:any): Observable<any> {
      let headers = new HttpHeaders().set('Content-Type', 'application/json')
          .set('Authorization', (this.accessToken != null) ? this.accessToken : '');
      let httpParams = new HttpParams()
          //.set("id", id)

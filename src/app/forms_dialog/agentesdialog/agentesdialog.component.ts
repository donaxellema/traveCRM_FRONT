...
@Component({
  ...
  imports: [CommonModule,
    ...
    MatSelectModule,
    MatIconModule],
  templateUrl: './agentesdialog.component.html',
  styleUrl: './agentesdialog.component.scss'
})
export class AgentesdialogComponent {
  ...
  constructor (
    ...
    public dialogRef: MatDialogRef<AgentesdialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    //@Inject(MAT_DIALOG_DATA) public personas: any,
  ...
  onSave(): void {
    ...
    if(this.tipoDialog=='Editar'){
      ...
      this._agentesService.postAgentes(objeto).subscribe(
        (response:any) => {
          console.log(response)
          if(response.code==200){
            this._systemServices.showAlertSuccessCenter(response.message);
